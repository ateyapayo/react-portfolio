...
import netflixList from "./assets/images/netflix.png";
import ladyKiron from "./assets/images/ladykiron.png";
import ecoEvents from "./assets/images/eco-events-vue-form.png";
import memeGenerator from "./assets/images/meme-generator.png";
import airBnb from "./assets/images/airbnb.png";
import workshop from "./assets/images/photography-workshop.png";

export const navLinks = ["home", "about", "skills", "work", "contact"];

export const socialIcons = [
  <a target="_blank" href="https://www.facebook.com/andreapianolandia">
    <FaFacebook />
  </a>,
  <a target="_blank" href="https://www.instagram.com/ateyapayo">
    <FaInstagram />
  </a>,
  <a target="_blank" href="https://www.linkedin.com/in/andreapiano">
    <FaLinkedin />
  </a>,
  <a target="_blank" href="https://github.com/ateyapayo">
    <FaGithub />
  </a>,
];
